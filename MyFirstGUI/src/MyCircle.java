...
static int counter = 0;
	...
	public MyCircle(double xPos, double yPos, Color carColor){
		this.xPos = xPos;
		this.yPos = yPos;
	...
	public void draw(Graphics g) {
		...
		Point2D.Double roofStart = new Point2D.Double (xPos+40, yPos+0);
		Point2D.Double roofEnd = new Point2D.Double (xPos+50, yPos+10);
